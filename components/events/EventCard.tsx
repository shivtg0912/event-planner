...
export default function EventCard({ event, isLastEventOnPage = false, currentPage = 1 }: EventCardProps) {
  ...
  return (
    <div 
      className="border shadow-md rounded-lg p-4 bg-white relative cursor-pointer transition-all duration-300 hover:shadow-xl hover:ring-2 hover:ring-blue-400 hover:ring-opacity-50 hover:bg-blue-50"
    ...
    >
        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button
              ...
              className="inline-flex justify-center items-center w-full px-2 py-1 text-sm font-medium text-gray-700 bg-white rounded-full cursor-pointer transition-colors duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-800 hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-400"
            >
      ...
      <h2 className="text-xl font-bold mb-2 text-gray-900">{event.eventName}</h2>
      <p className="text-gray-700 mb-2">{event.eventType}</p>
